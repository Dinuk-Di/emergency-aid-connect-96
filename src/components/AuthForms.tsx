  ...
  return (
    <div className="flex justify-center">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-safety-700">Emergency Aid Connect</CardTitle>
          <CardDescription>Login or create an account to report and manage emergencies</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <Form {...loginForm}>
                <form onSubmit={loginForm.handleSubmit(handleLoginSubmit)} className="space-y-6">
                  ...
                  <div className="text-xs text-gray-500">
                    ...
                    <p>- First Responder: responder@example.com / password</p>
        ...
        <CardFooter>
          <Button 
            variant="outline"
            className="w-full flex items-center gap-2 border-emergency-300 text-emergency-600 hover:bg-emergency-50"
